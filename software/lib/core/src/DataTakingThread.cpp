...
DataTakingThread::DataTakingThread(DataTaker *dataTaker):
  m_dataTaker(dataTaker), m_listener(dataTaker->m_listener),
...
void DataTakingThread::threadMain() {
  ...
  std::string reset_init("..\\bin\\memwrite.exe \\\\.\\xillybus_mem_8 1 15");
