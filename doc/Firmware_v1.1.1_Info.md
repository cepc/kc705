...
| Row Header (row 1) | \Åg1111\Åh[D31..D28], event_type [D27..D26], row_counter [D25..D20], 4bit counter [D19..D16], column_start [D15..D12], column_end [D11..D8], \Åg00\Åh [D7..D6], memory address [D5..D0] |
...
| Row Footer (row 1)| \Åg1110\Åh[D31..D28], row_start [D27..D22], row_end [D21..D16], 16bit frame counter [D15..D0], |
| Row Header (row 2) |  ... |
| Data (row 2) | ... |
| Data (row 2) | ... |
| ... | ... |
