    ...
    while True:
        ...
        try:
            ...
            while True:
                ...
                for i in range(1,49):
                    os.write(p, b'\x57\x53\xFC\xFE')
                    os.write(p, b'\x00\x01\x00\x02\x00\x02\x00\x03\x00\x04\x00\x05\x00\x06\x00\x07\x00\x08\x00\x09\x00\x0A\x00\x0B\x00\x0C\x00\x0D\x00\x0E\x00\x0F')
                    os.write(p, b'\x97\x98\xFB\xFD')
                os.write(p, b'\xF0\xF0\xF0\xF0')
                ...
                for i in range(1,49):
                    os.write(p, b'\x57\x53\xFC\xFE')
                    os.write(p, b'\x00\x03\x00\x04\x00\x02\x00\x03\x00\x04\x00\x05\x00\x06\x00\x07\x00\x08\x00\x09\x00\x0A\x00\x0B\x00\x0C\x00\x0D\x00\x0E\x00\x0F')
                    os.write(p, b'\x97\x98\xFB\xFD')
                os.write(p, b'\xF0\xF0\xF0\xF0')
