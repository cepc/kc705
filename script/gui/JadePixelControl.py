...
class MainWindow(QtWidgets.QMainWindow, form_class):
    def __init__(self, parent=None):
        ...
        self.ComboBox_Data.activated.connect(self.update)
        
        offlineAna.Signal.FrameSignal.connect(self.ProcessData)
...
#####################################################################
    ...
    def Draw_Pixel_Image(self):
        ...
        #self.Pixel_Canvas.colorbar(self.Pixel_Image, orientation='vertical', format='%.0e')
    ...
    def Btn_StartRun_Clicked(self, arg):
        #self.Btn_StartRun.setAttribute(QtCore.Qt.WA_UnderMouse, False)
        offlineAna.readRawFile(self.LineEdit_CurrentData.text(), 1, 5)
    ...
    def ProcessData(self, data):
        ...
        self.Pixel_Image.set_data(np.reshape(data, (16, 48)))
